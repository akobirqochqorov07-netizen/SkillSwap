...
exports.SkillsModule = SkillsModule = __decorate([
    (0, common_1.Module)({
        providers: [skills_service_1.SkillsService, verification_service_1.VerificationService, prisma_service_1.PrismaService, users_service_1.UsersService],
        controllers: [skills_controller_1.SkillsController],
        exports: [skills_service_1.SkillsService, verification_service_1.VerificationService],
    })
], SkillsModule);
